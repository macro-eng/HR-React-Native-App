...
import LeaveHome from "../components/HomeLeaveScreen";
import ExploreScreen from '../(tabs)/Login';
const Stack = createStackNavigator()
export default function StackNavigator(){
    return(
        <Stack.Navigator>
            <Stack.Screen name="leave" component={LeaveHome}  options={{headerShown:false }}/>
            <Stack.Screen name="Home" component={HomeScreen} options={{headerShown:false}} />
            <Stack.Screen name="Login" component={ExploreScreen} options={{headerShown:false}} />
            <Stack.Screen name="Leave" component={LeaveRequestForm}  options={{headerShown:false}}/>
